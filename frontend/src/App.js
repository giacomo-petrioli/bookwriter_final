      ...
      <div className="container mx-auto px-4 py-8">
        ...
        <div className="max-w-4xl mx-auto">
            ...
            <div className="fixed inset-0 bg-black bg-opacity-50 flex items-center justify-center z-50">
              <div className="bg-white rounded-lg p-8 text-center max-w-md mx-4">
                ...
                <p className="text-sm text-gray-600 mt-2">
                  {currentStep === 2 ? "Generating your book outline..." : "Processing your request..."}
                </p>
          ...
          {generatingAllChapters && (
            <div className="fixed inset-0 bg-black bg-opacity-50 flex items-center justify-center z-50">
              <div className="bg-white rounded-lg p-8 text-center max-w-md mx-4">
                <svg className="animate-spin mx-auto h-12 w-12 text-green-600 mb-4" xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24">
                  <circle className="opacity-25" cx="12" cy="12" r="10" stroke="currentColor" strokeWidth="4"></circle>
                  <path className="opacity-75" fill="currentColor" d="M4 12a8 8 0 018-8V0C5.373 0 0 5.373 0 12h4zm2 5.291A7.962 7.962 0 014 12H0c0 3.042 1.135 5.824 3 7.938l3-2.647z"></path>
                </svg>
                <p className="text-lg font-medium text-gray-800">🚀 Generating Your Complete Book</p>
                <p className="text-sm text-gray-600 mt-2">
                  AI is writing all {currentProject?.chapters} chapters based on your outline
                </p>
                <div className="mt-4 text-xs text-gray-500">
                  This may take several minutes. Please be patient while we create your book!
                </div>
