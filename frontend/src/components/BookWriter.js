...
const BACKEND_URL = 'https://ed9e644b-7694-41c3-b35b-625025142ecb.preview.emergentagent.com';
...
const BookWriter = () => {
  ...
  const WritingInterface = () => {
                  ...
                  <div className="flex gap-3">
                    {editingOutline ? (
                      <>
                        ...
                        >
                          {savingOutline ? "Saving..." : "Save Changes"}
                        </button>
                      </>
                    ) : (
                      <button
                        onClick={() => {
                          ...
                          // Parse current outline to structured chapters for editing
                          const chapters = parseOutlineToChapters(outline);
                          setStructuredChapters(chapters);
                        }}
    ...
    return (
      <div className="min-h-screen bg-gradient-to-br from-slate-900 via-purple-900 to-slate-900">
        {/* Custom Header for Writing Interface */}
        <nav className="bg-slate-900/80 backdrop-blur-sm border-b border-slate-700/50 p-6">
          <div className="container mx-auto flex justify-between items-center">
            ...
            <button
              ...
              className="flex items-center space-x-2 px-4 py-2 bg-slate-800/50 hover:bg-slate-700/50 rounded-lg border border-slate-700/50 transition-colors group"
            >
            ...
            {/* Center: Writing & Editing + Project Name */}
            <div className="flex items-center space-x-3">
              <span className="text-2xl">📚</span>
              <div className="text-center">
                <div className="text-white text-lg font-semibold">Writing & Editing</div>
                {currentProject && (
                  <div className="text-gray-300 text-sm" title={currentProject.title}>
